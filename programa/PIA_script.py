...
PIA_modulo.obtener_mediana(PIA_modulo.extraer_names_de_endpoint_a_list('pokemon'),'hp')
PIA_modulo.obtener_moda(PIA_modulo.extraer_names_de_endpoint_a_list('pokemon'),'hp')